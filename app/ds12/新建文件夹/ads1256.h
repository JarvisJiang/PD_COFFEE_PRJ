...
/*
// define commands 
#define ADS1256_CMD_WAKEUP   0x08    //完成SYNC和退出待机模式
#define ADS1256_CMD_RDATA    0x10     //读数据
#define ADS1256_CMD_RDATAC   0x03     //连续读数据
#define ADS1256_CMD_SDATAC   0x0f     //停止连续读数据 
#define ADS1256_CMD_RREG     0x20     //从寄存器度数据 
#define ADS1256_CMD_WREG     0x40     //向寄存器写数据 
...
#define ADS1256_CMD_SYNC     0x08     //同步AD转换 
#define ADS1256_CMD_STANDBY  0xfd     //待机模式开始 
#define ADS1256_CMD_REST    0x07      //复位
